...
- Requests are currently executed sequentially to avoid overwhelming public RPC endpoints. In a production setting, this would be extended with explicit rate limiting and controlled parallelism to support concurrent users.
